...
// const fontawesome4 = require('font-awesome-webpack-4');
...
const supportedBrowsers = [
  ...
  'chrome >= 21', // http://browserl.ist/?q=chrome+%3E%3D+21i
...
const srcPath = (file, watch = false) => {
  ...
  if (file === 'html') return './website/src/views/*.html';
  if (file === 'ejs' && watch === false) return './website/src/views/**/*.ejs'
